...
def pregunta_03():
    ...
    # Cree un pipeline que contenga un estimador MinMaxScaler y un estimador MLPRegressor
    pipeline = Pipeline(
        steps=[
            (
                "minmaxscaler",
...
def pregunta_04():
    ...
    # Cree una malla de búsqueda para el objeto GridSearchCV
    # con los siguientes parámetros de búsqueda:
    #   * De 1 a 8 neuronas en la capa oculta
    #   * Activación con la función `relu`.
    #   * Tasa de aprendizaje adaptativa
    #   * Momento con valores de 0.7, 0.8 y 0.9
    #   * Tasa de aprendizaje inicial de 0.01, 0.05, 0.1
